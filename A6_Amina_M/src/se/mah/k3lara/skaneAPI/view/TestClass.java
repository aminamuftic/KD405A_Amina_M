...
public class TestClass {
	...
	public static void main(String[] args) {
		String searchURL = Constants.getURL("80000","81216",20); //Malmö C = 80000,  Lund C, 81216 Malmö Gatorg 80100, Hässleholm C 93070. Den gör en sök URL mellan Malmö och Lund och den ber om 20 sökresultat.
		System.out.println(searchURL);
		System.out.println("// Results when searching:");
		
		Journeys journeys = Parser.getJourneys(searchURL); //Den gör en ny Journeys som innehåller alla Journey som man får från sök URLen.
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malm\"");
		ArrayList<Station> searchStations = new ArrayList<Station>(); //Den gör en ny lista på olika stationer. 
		searchStations.addAll(Parser.getStationsFromURL("Malm")); //Den söker på alla stationer som innehåller "Malm".
